...
class MissedQuestions extends StatelessWidget {
  static const routeName = "missedQuestions";
  const MissedQuestions({super.key});
        ...
        body: StreamBuilder<QuerySnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
              return const Center(child: Text('No missed questions available'));
            }
            ...
            final questions = snapshot.data!.docs.map((doc) {
              ...
              return Question(
                ...
                options:
                    List<String>.from(data['options'] ?? []), // Fetch options
              );
            }).toList();
